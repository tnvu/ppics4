...
# 9.  By convention, the statements of a program are often placed in a function 
#     called
#     a) import
#  X  b) main
#     c) program
...
# 4.  As you learn in a later chapter, many of the numbers stored in a computer 
#     are not exact values, but rather close approximations. For example, the 
#     value 0.1 might be stored as 0.10000000000000000555. Usually, such small
#     difference are not a problem; however, given what you have learned about 
#     chaotic behavior in Chapter 1, you should realize the need for caution in
#     certain situations. Can you think of examples where this might be a
#     problem? Explain.
...
#     x = 3.9 * 0.49724999999999997 * (1 - 0.49724999999999997) = 0.97497050625
#     x = 3.9 * 0.97497050625 * (1 - 0.97497050625) = 0.09517177095121285
#     x = 3.9 * 0.09517177095121285 * (1 - 0.09517177095121285) = 0.3358450093643686
#     x = 3.9 * 0.3358450093643686 * (1 - 0.3358450093643686) = 0.8699072422927216
#     x = 3.9 * 0.8699072422927216 * (1 - 0.8699072422927216) = 0.4413576651876355
#     x = 3.9 * 0.4413576651876355 * (1 - 0.4413576651876355) = 0.9615881986142427
#     x = 3.9 * 0.9615881986142427 * (1 - 0.9615881986142427) = 0.14405170611022783
#     x = 3.9 * 0.14405170611022783 * (1 - 0.14405170611022783) = 0.48087316710014555
#     x = 3.9 * 0.48087316710014555 * (1 - 0.48087316710014555) = 0.9735732406265619